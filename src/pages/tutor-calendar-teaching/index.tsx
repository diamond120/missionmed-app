...
function formatDate(inputDateStr) {
  ...
  const hours = Number(inputDate.getHours().toString().padStart(2, '0'))
...
/**
 * This functionality move to `missionmed/ucat-exam-backend` repo
 * @deprecated - not in use - 2024-10-09
 */
export default function TutorCalendarTeaching(tutorId?: number, next?: any, form?: any) {
