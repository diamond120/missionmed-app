...
const SessionList = ({ date, sessions, type, handleRateSession=()=>{} }) => (
...
const Mysessions = ({ upcomingSessions, pastSessions }) => {
  ...
  return (
    <>
      ...
      <RateSession session={rateSession} isOpen={Object.keys(rateSession ?? {}).length > 0 } handleRateCancel={handleRateCancel} />
    </>
  );
};
