...
function Performance() {
    ...
    const data = [
        100, 150, 350, 400, 450, 520, 600, 700, 900, 850, 750, 600, 520, 450, 320, 200, 100
    ...
    const configBar = {
        data: [{ letter: 'A', frequency: 15 }, { letter: 'B', frequency: 0 }, { letter: 'C', frequency: 10 }, { letter: 'D', frequency: 35 }, { letter: 'E', frequency: 5 }, { letter: 'F', frequency: 20 }],
        xField: 'letter',
        yField: 'frequency',
        height: 150,
        width: 300,
        ...
        <div className='performance-tab' >
            ...
            <div className='completed-mocks'>
                <div className='results'>
                    ...
                    <span className='title'>UCAT Diagnostic Mock(30-minutes) Results</span>

                    <div className='question-item' >
                        <span className='question-title'>Verbal Reasoning Questions</span>
                        <Table columns={columns} dataSource={verbalData} pagination={false} bordered
                            footer={() => {
                                return (
                                    <div className='footer-table' >
                                        ...
                                        <div className='footer-value' >
                                            {resion?.map((item, index) => (
                                                <div key={index} className='value' style={{ backgroundColor: item.color }}>{item.value}</div>
                                            ))}
                                        </div>
                                    </div>
                                )
                    ...
                    <div className='question-item'>
                        ...
                        <Table columns={decisionColumns} dataSource={partialData} pagination={false} bordered
                            footer={() => {
                                return (
                                    <div className='footer-table' >
                    ...
                    <div className='question-item'>
                        <span className='question-title'>Quantitative Reasoning Questions</span>
                        <Table columns={columns} dataSource={verbalData} pagination={false} bordered
                            footer={() => {
                                return (
                                    <div className='footer-table' >
                ...
                <div className='predicated' >
                    ...
                    <div className='container'>
                        <Table columns={PredicatedColumns} dataSource={predicatedData} pagination={false} bordered />
...
const resion = [{ value: '25s', color: '#a8e2c8' }, { value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' }, { value: '32s', color: '#f7c2a0' }, { value: '25s', color: '#a8e2c8' }, { value: '35s', color: '#a8e2c8' }, { value: '22s', color: '#eda2bf' }, { value: '43s', color: '#a8e2c8' },{ value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' }, { value: '32s', color: '#f7c2a0' }, { value: '25s', color: '#a8e2c8' }, { value: '35s', color: '#a8e2c8' }, { value: '22s', color: '#eda2bf' }, { value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' }, { value: '32s', color: '#f7c2a0' }, { value: '25s', color: '#a8e2c8' }, { value: '35s', color: '#a8e2c8' }, { value: '22s', color: '#eda2bf' }, ]
const quantitative = [{ value: '25s', color: '#a8e2c8' }, { value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' }, { value: '32s', color: '#f7c2a0' }, { value: '25s', color: '#a8e2c8' }, { value: '35s', color: '#a8e2c8' }, { value: '22s', color: '#eda2bf' }, { value: '42s', color: '#eda2bf' }, { value: '43s', color: '#a8e2c8' }, { value: '25s', color: '#a8e2c8' },{ value: '25s', color: '#a8e2c8' }, { value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' }, { value: '25s', color: '#a8e2c8' }, { value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' }, { value: '25s', color: '#a8e2c8' }, { value: '15s', color: '#a8e2c8' },{ value: '25s', color: '#a8e2c8' }, { value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' }, { value: '25s', color: '#a8e2c8' }, { value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' }, { value: '25s', color: '#a8e2c8' }, { value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' }, { value: '25s', color: '#a8e2c8' }, { value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' }, { value: '25s', color: '#a8e2c8' }, { value: '15s', color: '#a8e2c8' }, { value: '29s', color: '#a8e2c8' },  { value: '32s', color: '#f7c2a0' }, { value: '25s', color: '#a8e2c8' }, { value: '35s', color: '#a8e2c8' }, { value: '22s', color: '#eda2bf' },  { value: '32s', color: '#f7c2a0' }, { value: '25s', color: '#a8e2c8' }, { value: '35s', color: '#a8e2c8' }, { value: '22s', color: '#eda2bf' },  { value: '32s', color: '#f7c2a0' }, { value: '25s', color: '#a8e2c8' }, { value: '35s', color: '#a8e2c8' }, { value: '22s', color: '#eda2bf' },  { value: '32s', color: '#f7c2a0' }, { value: '25s', color: '#a8e2c8' }, { value: '35s', color: '#a8e2c8' }, { value: '22s', color: '#eda2bf' }, ]
