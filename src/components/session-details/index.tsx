...
const SessionDetails = ({moduleType,upcomingInterview, upcomingSessions, pastSessions, agenda, handleEditAgenda, updatePastSession, handleReschedule,cancleUpSession}) => {
    return (
        <>
            ...
            <UpcomingSession upcomingInterview={upcomingInterview} handleReschedule={handleReschedule} sessionType="session"/>
