...
const SessionDetails = ({moduleType,upcomingInterview, upcomingSessions, pastSessions, agenda, handleEditAgenda, updatePastSession, handleReschedule,cancleUpSession, handleEditLink, freezeSessions}) => {
