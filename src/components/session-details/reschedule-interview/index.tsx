  ...
  const Step2From = () => {
    return <>
      <div className={"book-time-cal"}>
        <Calender tutorId={interviewSummary?.tutor_id} studentId={interviewSummary?.student_id} sessionId={interviewSummary?.id} rescheduleDate={interviewSummary?.student_session_start_time} form={form} moduleType={moduleType} next={next} timezone={timezone} />
        {(userRole === 'tutor') && (
          <Alert 
            style={{ top: 23 }} 
